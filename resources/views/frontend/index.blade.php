...
@push('styles')
    <style>
        ...
        @media (max-width: 767px) {
            #Gslider .carousel-inner { height: 220px; }
            #Gslider .carousel-inner .carousel-caption { bottom: auto; top: 50%; transform: translateY(-50%); }
            #Gslider .carousel-inner .carousel-caption h1 { font-size: 20px; line-height: 1.2; }
            #Gslider .carousel-inner .carousel-caption p { display: none; }
            #Gslider .carousel-inner .carousel-caption .btn { padding: 7px 16px; font-size: 12px; }
            #Gslider .carousel-indicators { bottom: 10px; }
        }
        @media (max-width: 480px) {
            #Gslider .carousel-inner { height: 180px; }
            #Gslider .carousel-inner .carousel-caption h1 { font-size: 16px; }
        }
    </style>
@endpush
