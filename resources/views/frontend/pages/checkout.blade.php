...
@section('main-content')
    ...
    <div class="checkbox">
        <form-group>
            <input name="payment_method" id="pay_cod" type="radio" value="cod" required>
            <label for="pay_cod"> Cash On Delivery</label><br>

            <input name="payment_method" id="pay_mpesa" type="radio" value="mpesa" required>
            <label for="pay_mpesa">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/120px-M-PESA_LOGO-01.svg.png"
                     alt="M-Pesa" style="height:22px;vertical-align:middle;margin-right:4px;">
                M-Pesa (STK Push)
            </label>

            <!-- M-Pesa phone number field -->
            <div id="mpesaPhoneField" style="display:none; margin-top:10px;">
                <label for="mpesa_phone" style="font-weight:600;">M-Pesa Phone Number <span style="color:red">*</span></label>
                ...
                <small style="color:#666;">Enter the Safaricom number registered with M-Pesa.</small>
            </div>
        </form-group>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $('input[name="payment_method"]').change(function() {
            if ($(this).val() === 'mpesa') {
                $('#mpesaPhoneField').show();
                $('#mpesa_phone').prop('required', true);
            } else {
                $('#mpesaPhoneField').hide();
                $('#mpesa_phone').prop('required', false);
            }
        });
    });
</script>
